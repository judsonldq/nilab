...
def run_model(write_path, data, para_dict):
    ...
    third_block_single = conv_block(input_name_list=second_block_single, input_shape=single_length, ratio=ratio,
    ...
    third_block_p = conv_block(input_name_list=second_block_p, input_shape=p_length, ratio=ratio,
    ...
    third_block_q = conv_block(input_name_list=second_block_q, input_shape=q_length, ratio=ratio,
    ...
    third_block_t = conv_block(input_name_list=second_block_t, input_shape=t_length, ratio=ratio,
    ...
    model = Model(inputs=[input_beat, input_p_wave, input_q_wave, input_t_wave], outputs=output)
...
if __name__ == "__main__":
    para_dict = {'min_delta': 0.002, 'ratio': 2, 'bias': 2, 'epoch': 50, 'times': 10, 'patience': 4}
